...
contextBridge.exposeInMainWorld('maxx', {
  ...
  flowContext: () => ipcRenderer.invoke('flow-context'),
  flowSaveCheckpoint: (payload) => ipcRenderer.invoke('flow-save-checkpoint', payload),
  flowCopyResume: (payload) => ipcRenderer.invoke('flow-copy-resume', payload),
