...
const DEFAULT_CONFIG = {
  ...
  providers: {
    ...
    opencode: { name: 'OpenCode', plan: 'Pro', monthly: 20, enabled: false, tier: 'hidden' },
    opencodego: { name: 'OpenCode Go', plan: 'Pro', monthly: 20, enabled: false, tier: 'core' },
    ...
    jetbrains: { name: 'JetBrains AI', plan: 'AI Pro', monthly: 20, enabled: false, tier: 'core' },
    ...
    perplexity: { name: 'Perplexity', plan: 'Pro', monthly: 20, enabled: false, tier: 'core' },
    ...
    factory: { name: 'Droid', plan: 'Factory', monthly: 20, enabled: false, tier: 'core' },
    antigravity: { name: 'Antigravity', plan: 'Google AI', monthly: 20, enabled: false, tier: 'core' },
    minimax: { name: 'MiniMax', plan: 'Coding Plan', monthly: 20, enabled: false, tier: 'core' },
    ...
    zai: { name: 'z.ai', plan: 'API', monthly: 20, enabled: false, tier: 'core' },
